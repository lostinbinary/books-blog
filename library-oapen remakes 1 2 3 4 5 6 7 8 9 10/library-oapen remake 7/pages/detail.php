...
<html lang="en">
  ...
  <body>
    ...
    <div class="coldeddd-map centered-element">
      
    </div>
    <div class="coldeddd-container centered-element">
      <div class="coldeddd-boxes">
        <h1><?= $data->book->title ?> </h1>
        <p><?= $data->book->description ?> </p>
        <div class="coldeddd-iframe-description">
          <!-- <div class="coldeddd-description">
            <div>
              <span>Author</span>
          ...
          <div class="coldeddd-iframe">
            <div>
              <iframe src=""></iframe>
              <div
                class="coldeddd-iframe-btn"
    ...
    <footer>
      <div class="centered-element">
        <div class="coldeddd-footer-logo">
          <a href="/"><?= $messages['logo_name'] ?></a>
          <div>
            <ul>
