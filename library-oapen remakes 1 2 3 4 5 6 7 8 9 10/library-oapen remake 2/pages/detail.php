...
<html lang="en">
  ...
  <body>
    ...
    <div class="dealinggg-map centered-element">
      
    </div>
    <div class="dealinggg-container centered-element">
      <div class="dealinggg-boxes">
        <h1><?= $data->book->title ?> </h1>
        <p><?= $data->book->description ?> </p>
        <div class="dealinggg-iframe-description">
          <!-- <div class="dealinggg-description">
            <div>
              <span>Author</span>
          ...
          <div class="dealinggg-iframe">
            <div>
              <iframe src=""></iframe>
              <div
                class="dealinggg-iframe-btn"
        ...
        <div class="dealinggg-boxes-list">
    ...
    <footer>
      <div class="centered-element">
        <div class="dealinggg-footer-logo">
          <a href="/"><?= $messages['logo_name'] ?></a>
          <div>
            <ul>
