...
<html lang="en">
  ...
  <body>
    ...
    <div class="aircraftsss-map centered-element">
      
    </div>
    <div class="aircraftsss-container centered-element">
      <div class="aircraftsss-boxes">
        <h1><?= $data->book->title ?> </h1>
        <p><?= $data->book->description ?> </p>
        <div class="aircraftsss-iframe-description">
          <!-- <div class="aircraftsss-description">
            <div>
              <span>Author</span>
          ...
          <div class="aircraftsss-iframe">
            <div>
              <iframe src=""></iframe>
              <div
                class="aircraftsss-iframe-btn"
              ...
              <span class="aircraftsss-circles">
                <div>
                  <span></span>
                </div>
              </span>
        ...
        <div class="aircraftsss-boxes-list">
    ...
    <footer>
      <div class="centered-element">
        <div class="aircraftsss-footer-logo">
          <a href="/"><?= $messages['logo_name'] ?></a>
          <div>
            <ul>
