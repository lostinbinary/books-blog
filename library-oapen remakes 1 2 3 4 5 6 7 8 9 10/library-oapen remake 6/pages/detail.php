...
<html lang="en">
  ...
  <body>
    ...
    <div class="somehowww-map centered-element">
      
    </div>
    <div class="somehowww-container centered-element">
      <div class="somehowww-boxes">
        <h1><?= $data->book->title ?> </h1>
        <p><?= $data->book->description ?> </p>
        <div class="somehowww-iframe-description">
          <!-- <div class="somehowww-description">
            <div>
              <span>Author</span>
          ...
          <div class="somehowww-iframe">
            <div>
              <iframe src=""></iframe>
              <div
                class="somehowww-iframe-btn"
        ...
        <div class="somehowww-boxes-list">
    ...
    <footer>
      <div class="centered-element">
        <div class="somehowww-footer-logo">
          <a href="/"><?= $messages['logo_name'] ?></a>
          <div>
            <ul>
