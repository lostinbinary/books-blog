...
<html lang="en">
  ...
  <body>
    ...
    <div class="sickeddd-container centered-element">
      <div class="sickeddd-boxes">
        <h1><?= $data->book->title ?> </h1>
        <p><?= $data->book->description ?> </p>
        <div class="sickeddd-iframe-description">
          <div class="sickeddd-iframe">
            <div>
              <iframe src=""></iframe>
              <div
                class="sickeddd-iframe-btn"
        ...
        <div class="sickeddd-boxes-list">
                  <?php foreach($data->book->relateds as $book): ?>
            <div data-link="<?= $book->path ?>">
                <a href="<?= $book->path ?>" class="sickeddd-title"><?= $book->title ?></a>

                <span
                class="sickeddd-view-book"
                data-pdf="<?= $book->url ?>"
                ><img data-src="/assets/img/view-svgrepo-com.svg"
                /></span>
                <a href="<?= $book->path ?>" class="sickeddd-img"
