...
<html lang="en">
  ...
  <body>
    ...
    <div class="hollyy-container centered-element">
      <div class="hollyy-boxes">
        <h1><?= $data->book->title ?> </h1>
        <p><?= $data->book->description ?> </p>
        <div class="hollyy-iframe-description">
          <div class="hollyy-iframe">
            <div>
              <iframe src=""></iframe>
              <div
                class="hollyy-iframe-btn"
        ...
        <div class="hollyy-boxes-list">
          <?php foreach($data->book->relateds as $book): ?>
            <div data-link="<?= $book->path ?>">
                <a href="<?= $book->path ?>" class="hollyy-title"><?= $book->title ?></a>

                <span
                class="hollyy-view-book"
                data-pdf="<?= $book->url ?>"
                ><img data-src="/assets/img/view-svgrepo-com.svg"
                /></span>
                <a href="<?= $book->path ?>" class="hollyy-img"
