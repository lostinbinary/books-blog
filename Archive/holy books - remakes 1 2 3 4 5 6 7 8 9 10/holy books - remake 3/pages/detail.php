...
<html lang="en">
  ...
  <body>
    ...
    <div class="gradientsss-container centered-element">
      <div class="gradientsss-boxes">
        <h1><?= $data->book->title ?> </h1>
        <p><?= $data->book->description ?> </p>
        <div class="gradientsss-iframe-description">
          <div class="gradientsss-iframe">
            <div>
              <iframe src=""></iframe>
              <div
                class="gradientsss-iframe-btn"
              ...
              <span class="gradientsss-circles">
                <div>
                  <span></span>
                </div>
              </span>
        ...
        <div class="gradientsss-boxes-list">
          <?php foreach($data->book->relateds as $book): ?>
            <div data-link="<?= $book->path ?>">
              <a href="<?= $book->path ?>" class="gradientsss-title"><?= $book->title ?></a>

              <span
              class="gradientsss-view-book"
              data-pdf="<?= $data->book->url ?>"
              ><img data-src="/assets/img/view-svgrepo-com.svg"
              /></span>
              <a href="<?= $book->path ?>" class="gradientsss-img"
      ...
      <div class="gradientsss-relateds">
                <ul>
    ...
    <div class="gradientsss-book-pop">
      <div>
        <div>
    ...
    <div class="gradientsss-book-spinn">
      <div>
        <span></span>
      </div>
    </div>
