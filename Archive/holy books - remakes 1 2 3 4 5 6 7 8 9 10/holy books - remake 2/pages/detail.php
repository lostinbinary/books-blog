...
<html lang="en">
  ...
  <body>
    ...
    <div class="role-modelll-container centered-element">
      <div class="role-modelll-boxes">
        <h1><?= $data->book->title ?> </h1>
        <p><?= $data->book->description ?> </p>
        <div class="role-modelll-iframe-description">
          <div class="role-modelll-iframe">
            <div>
              <iframe src=""></iframe>
              <div
                class="role-modelll-iframe-btn"
              ...
              <span class="role-modelll-circles">
                <div>
                  <span></span>
                </div>
              </span>
        ...
        <div class="role-modelll-boxes-list">
          <?php foreach($data->book->relateds as $book): ?>
            <div data-link="<?= $book->path ?>">
                <a href="<?= $book->path ?>" class="role-modelll-title"><?= $book->title ?></a>

                <span
                class="role-modelll-view-book"
                data-pdf="<?= $book->url ?>"
                ><img data-src="/assets/img/view-svgrepo-com.svg"
                /></span>
                <a href="<?= $book->path ?>" class="role-modelll-img"
      ...
      <div class="role-modelll-relateds">
                <ul>
    ...
    <div class="role-modelll-book-pop">
      <div>
        <div>
    ...
    <div class="role-modelll-book-spinn">
      <div>
        <span></span>
      </div>
    </div>
