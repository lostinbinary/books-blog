...
<html lang="en">
  ...
  <body>
    ...
    <div class="throughhh-container centered-element">
      <div class="throughhh-boxes">
        <h1><?= $data->book->title ?> </h1>
        <p><?= $data->book->description ?> </p>
        <div class="throughhh-iframe-description">
          <div class="throughhh-iframe">
            <div>
              <iframe src=""></iframe>
              <div
                class="throughhh-iframe-btn"
        ...
        <div class="throughhh-boxes-list">
                  <?php foreach($data->book->relateds as $book): ?>
            <div data-link="<?= $book->path ?>">
                <a href="<?= $book->path ?>" class="throughhh-title"><?= $book->title ?></a>

                <span
                class="throughhh-view-book"
                data-pdf="<?= $book->url ?>"
                ><img data-src="/assets/img/view-svgrepo-com.svg"
                /></span>
                <a href="<?= $book->path ?>" class="throughhh-img"
    ...
    <div class="throughhh-book-spinn">
      <div>
        <span></span>
      </div>
    </div>
