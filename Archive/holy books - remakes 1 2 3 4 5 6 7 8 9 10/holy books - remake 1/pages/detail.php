...
<html lang="en">
  ...
  <body>
    ...
    <div class="regularrrr-container centered-element">
      <div class="regularrrr-boxes">
        <h1><?= $data->book->title ?> </h1>
        <p><?= $data->book->description ?> </p>
        <div class="regularrrr-iframe-description">
          <div class="regularrrr-iframe">
            <div>
              <iframe src=""></iframe>
              <div
                class="regularrrr-iframe-btn"
        ...
        <div class="regularrrr-boxes-list">
          <?php foreach($data->book->relateds as $book): ?>
            <div data-link="<?= $book->path ?>">
                <a href="<?= $book->path ?>" class="regularrrr-title"><?= $book->title ?></a>

                <span
                class="regularrrr-view-book"
                data-pdf="<?= $book->url ?>"
                ><img data-src="/assets/img/view-svgrepo-com.svg"
                /></span>
                <a href="<?= $book->path ?>" class="regularrrr-img"
    ...
    <div class="regularrrr-book-spinn">
      <div>
        <span></span>
      </div>
    </div>
