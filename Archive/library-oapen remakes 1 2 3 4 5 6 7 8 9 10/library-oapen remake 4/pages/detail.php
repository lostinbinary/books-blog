...
<html lang="en">
  ...
  <body>
    ...
    <div class="lionsss-map centered-element">
      
    </div>
    <div class="lionsss-container centered-element">
      <div class="lionsss-boxes">
        <h1><?= $data->book->title ?> </h1>
        <p><?= $data->book->description ?> </p>
        <div class="lionsss-iframe-description">
          <!-- <div class="lionsss-description">
            <div>
              <span>Author</span>
          ...
          <div class="lionsss-iframe">
            <div>
              <iframe src=""></iframe>
              <div
                class="lionsss-iframe-btn"
