...
<html lang="en">
  ...
  <body>
    ...
    <div class="libraryy-map centered-element">
      
    </div>
    <div class="libraryy-container centered-element">
      <div class="libraryy-boxes">
        <h1><?= $data->book->title ?> </h1>
        <p><?= $data->book->description ?> </p>
        <div class="libraryy-iframe-description">
          <!-- <div class="libraryy-description">
            <div>
              <span>Author</span>
          ...
          <div class="libraryy-iframe">
            <div>
              <iframe src=""></iframe>
              <div
                class="libraryy-iframe-btn"
    ...
    <footer>
      <div class="centered-element">
        <div class="libraryy-footer-logo">
          <a href="/"><?= $messages['logo_name'] ?></a>
          <div>
            <ul>
