...
<html lang="en">
  ...
  <body>
    ...
    <div class="stepssss-map centered-element">
      
    </div>
    <div class="stepssss-container centered-element">
      <div class="stepssss-boxes">
        <h1><?= $data->book->title ?> </h1>
        <p><?= $data->book->description ?> </p>
        <div class="stepssss-iframe-description">
          <!-- <div class="stepssss-description">
            <div>
              <span>Author</span>
          ...
          <div class="stepssss-iframe">
            <div>
              <iframe src=""></iframe>
              <div
                class="stepssss-iframe-btn"
    ...
    <footer>
      <div class="centered-element">
        <div class="stepssss-footer-logo">
          <a href="/"><?= $messages['logo_name'] ?></a>
          <div>
            <ul>
