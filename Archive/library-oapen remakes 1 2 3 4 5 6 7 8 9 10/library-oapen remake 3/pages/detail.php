...
<html lang="en">
  ...
  <body>
    ...
    <div class="sortinggg-map centered-element">
      
    </div>
    <div class="sortinggg-container centered-element">
      <div class="sortinggg-boxes">
        <h1><?= $data->book->title ?> </h1>
        <p><?= $data->book->description ?> </p>
        <div class="sortinggg-iframe-description">
          <!-- <div class="sortinggg-description">
            <div>
              <span>Author</span>
          ...
          <div class="sortinggg-iframe">
            <div>
              <iframe src=""></iframe>
              <div
                class="sortinggg-iframe-btn"
        ...
        <div class="sortinggg-boxes-list">
    ...
    <footer>
      <div class="centered-element">
        <div class="sortinggg-footer-logo">
          <a href="/"><?= $messages['logo_name'] ?></a>
          <div>
            <ul>
