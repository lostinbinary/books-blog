window.addEventListener("load", function () {
  const boxes = document.querySelectorAll(".milchhhh-boxes-list>div");
  ...
  const viewBtn = document.querySelectorAll(".milchhhhe-view");
  const splinner = document.querySelector(".milchhhhe-book-spinn");
  const pdfPop = document.querySelector(".milchhhhe-book-pop");
  const iframePop = document.querySelector(".milchhhhe-book-pop iframe");
  const iframePopBody = document.querySelector(".milchhhhe-book-pop>div>div>div");
  boxes.forEach((item, idx) => {
    let dataLink = item.getAttribute("data-link");
