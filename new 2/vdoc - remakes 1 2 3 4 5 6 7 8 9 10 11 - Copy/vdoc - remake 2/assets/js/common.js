window.addEventListener("load", function () {
  const boxes = document.querySelectorAll(".dubissttt-boxes-list>div");
  ...
  const viewBtn = document.querySelectorAll(".dubissttte-view");
  const splinner = document.querySelector(".dubissttte-book-spinn");
  const pdfPop = document.querySelector(".dubissttte-book-pop");
  const iframePop = document.querySelector(".dubissttte-book-pop iframe");
  const iframePopBody = document.querySelector(".dubissttte-book-pop>div>div>div");
  boxes.forEach((item, idx) => {
    let dataLink = item.getAttribute("data-link");
