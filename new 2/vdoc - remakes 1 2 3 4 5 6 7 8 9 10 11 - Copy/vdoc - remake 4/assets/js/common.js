window.addEventListener("load", function () {
  const boxes = document.querySelectorAll(".ichbinn-boxes-list>div");
  ...
  const viewBtn = document.querySelectorAll(".ichbinne-view");
  const splinner = document.querySelector(".ichbinne-book-spinn");
  const pdfPop = document.querySelector(".ichbinne-book-pop");
  const iframePop = document.querySelector(".ichbinne-book-pop iframe");
  const iframePopBody = document.querySelector(".ichbinne-book-pop>div>div>div");
  boxes.forEach((item, idx) => {
    let dataLink = item.getAttribute("data-link");
