const iframeBtn = document.querySelector(
  ".wasserrr-descriptions span[data-link]",
);
const iframe = document.querySelector(".wasserrr-iframe iframe");
iframeBtn.addEventListener("click", function (e) {
  let curr = e.currentTarget.getAttribute("data-link");
  iframe.src = curr;
});

const moreLess = document.querySelector(".wasserrr-less-more");
const textEl = document.querySelector(".wasserrr-staff-text");
