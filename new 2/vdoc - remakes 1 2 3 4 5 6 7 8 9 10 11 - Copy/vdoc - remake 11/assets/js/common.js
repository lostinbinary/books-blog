window.addEventListener("load", function () {
  const boxes = document.querySelectorAll(".bruderrs-boxes-list>div");
  ...
  const viewBtn = document.querySelectorAll(".bruderrse-view");
  const splinner = document.querySelector(".bruderrse-book-spinn");
  const pdfPop = document.querySelector(".bruderrse-book-pop");
  const iframePop = document.querySelector(".bruderrse-book-pop iframe");
  const iframePopBody = document.querySelector(".bruderrse-book-pop>div>div>div");
  boxes.forEach((item, idx) => {
    let dataLink = item.getAttribute("data-link");
