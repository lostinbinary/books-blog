const iframeBtn = document.querySelector(
  ".vdoccc-descriptions span[data-link]",
);
const iframe = document.querySelector(".vdoccc-iframe iframe");
iframeBtn.addEventListener("click", function (e) {
  let curr = e.currentTarget.getAttribute("data-link");
  iframe.src = curr;
});

const moreLess = document.querySelector(".vdoccc-less-more");
const textEl = document.querySelector(".vdoccc-staff-text");
