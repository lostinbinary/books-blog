...
<html lang="en">
  ...
  <body>
    ...
    <div class="vdoccc-container centered-element">
      <div>
        <div class="vdoccc-boxes">
          <div class="vdoccc-iframe-description">
            <div class="vdoccc-iframe">
              <div>
                <iframe src=""></iframe>
              </div>
