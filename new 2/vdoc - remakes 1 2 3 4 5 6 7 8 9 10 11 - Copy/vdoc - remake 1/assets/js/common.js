window.addEventListener("load", function () {
  const boxes = document.querySelectorAll(".inheritencee-boxes-list>div");
  ...
  const viewBtn = document.querySelectorAll(".inheritenceee-view");
  const splinner = document.querySelector(".inheritenceee-book-spinn");
  const pdfPop = document.querySelector(".inheritenceee-book-pop");
  const iframePop = document.querySelector(".inheritenceee-book-pop iframe");
  const iframePopBody = document.querySelector(".inheritenceee-book-pop>div>div>div");
  boxes.forEach((item, idx) => {
    let dataLink = item.getAttribute("data-link");
