const iframeBtn = document.querySelector(
  ".inheritencee-descriptions span[data-link]",
);
const iframe = document.querySelector(".inheritencee-iframe iframe");
iframeBtn.addEventListener("click", function (e) {
  let curr = e.currentTarget.getAttribute("data-link");
  iframe.src = curr;
});

const moreLess = document.querySelector(".inheritencee-less-more");
const textEl = document.querySelector(".inheritencee-staff-text");
