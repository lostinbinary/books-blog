...
<html lang="en">
  ...
  <body>
    ...
    <div class="inheritencee-container centered-element">
      <div>
        <div class="inheritencee-boxes">
          <div class="inheritencee-iframe-description">
            <div class="inheritencee-iframe">
              <div>
                <iframe src=""></iframe>
              </div>
        ...
        <div class="inheritencee-descriptions">
    ...
    <div class="inheritenceee-book-pop">
      <div>
        <div>
    ...
    <div class="inheritenceee-book-spinn">
      <div>
        <span></span>
      </div>
    </div>
