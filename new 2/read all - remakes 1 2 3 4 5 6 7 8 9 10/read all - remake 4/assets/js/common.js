window.addEventListener("load", function () {
  const boxes = document.querySelectorAll(".emphasizee-boxes-list>div");
  ...
  const viewBtn = document.querySelectorAll(".emphasizee-vdoc-view");
  const splinner = document.querySelector(".emphasizee-vdoc-book-spinn");
  const pdfPop = document.querySelector(".emphasizee-vdoc-book-pop");
  const iframePop = document.querySelector(".emphasizee-vdoc-book-pop iframe");
  const iframePopBody = document.querySelector(".emphasizee-vdoc-book-pop>div>div>div");
  boxes.forEach((item, idx) => {
    let dataLink = item.getAttribute("data-link");
