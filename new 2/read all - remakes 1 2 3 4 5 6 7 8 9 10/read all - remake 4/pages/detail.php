...
<html lang="en">
  ...
  <body>
    ...
    <div class="emphasizee-container centered-element">
      <div>
        <div class="emphasizee-boxes">
          <div class="emphasizee-iframe-description">
            <div class="emphasizee-iframe">
              <h1><?= $data->book->title ?> </h1>
              <p><?= $data->book->description ?> </p>
              <div>
                <iframe src=""></iframe>
                <div class="emphasizee-descriptions">
                  <span>
    ...
    <div class="emphasizee-vdoc-book-pop">
      <div>
        <div>
    ...
    <div class="emphasizee-vdoc-book-spinn">
      <div>
        <span></span>
      </div>
    </div>
