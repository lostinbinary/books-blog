window.addEventListener("load", function () {
  const boxes = document.querySelectorAll(".couldddd-boxes-list>div");
  ...
  const viewBtn = document.querySelectorAll(".couldddd-vid-view");
  const splinner = document.querySelector(".couldddd-vid-book-spinn");
  const pdfPop = document.querySelector(".couldddd-vid-book-pop");
  const iframePop = document.querySelector(".couldddd-vid-book-pop iframe");
  const iframePopBody = document.querySelector(".couldddd-vid-book-pop>div>div>div");
  boxes.forEach((item, idx) => {
    let dataLink = item.getAttribute("data-link");
