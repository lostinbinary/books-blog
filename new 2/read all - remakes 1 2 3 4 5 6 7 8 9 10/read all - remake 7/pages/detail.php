...
<html lang="en">
  ...
  <body>
    ...
    <div class="couldddd-container centered-element">
      <div>
        <div class="couldddd-boxes">
          <div class="couldddd-iframe-description">
            <div class="couldddd-iframe">
              <h1><?= $data->book->title ?> </h1>
              <p><?= $data->book->description ?> </p>
              <div>
                <iframe src=""></iframe>
                <div class="couldddd-descriptions">
                  <span>
    ...
    <div class="couldddd-vid-book-pop">
      <div>
        <div>
    ...
    <div class="couldddd-vid-book-spinn">
      <div>
        <span></span>
      </div>
    </div>
