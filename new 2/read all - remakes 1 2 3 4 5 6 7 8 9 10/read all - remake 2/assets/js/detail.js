const iframeBtn = document.querySelector(
  ".defenciveee-descriptions span[data-link]",
);
const overlay = document.querySelector(".defenciveee-descriptions");
const iframe = document.querySelector(".defenciveee-iframe iframe");
...
const moreLess = document.querySelector(".defenciveee-less-more");
const textEl = document.querySelector(".defenciveee-staff-text");
