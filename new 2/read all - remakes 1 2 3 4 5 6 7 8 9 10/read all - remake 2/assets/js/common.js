window.addEventListener("load", function () {
  const boxes = document.querySelectorAll(".defenciveee-boxes-list>div");
  ...
  const viewBtn = document.querySelectorAll(".defenciveee-vid-view");
  const splinner = document.querySelector(".defenciveee-vid-book-spinn");
  const pdfPop = document.querySelector(".defenciveee-vid-book-pop");
  const iframePop = document.querySelector(".defenciveee-vid-book-pop iframe");
  const iframePopBody = document.querySelector(".defenciveee-vid-book-pop>div>div>div");
  boxes.forEach((item, idx) => {
    let dataLink = item.getAttribute("data-link");
