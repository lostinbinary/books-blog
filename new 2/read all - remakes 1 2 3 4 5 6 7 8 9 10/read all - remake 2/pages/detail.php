...
<html lang="en">
  ...
  <body>
    ...
    <div class="defenciveee-container centered-element">
      <div>
        <div class="defenciveee-boxes">
          <div class="defenciveee-iframe-description">
            <div class="defenciveee-iframe">
              <h1><?= $data->book->title ?> </h1>
              <p><?= $data->book->description ?> </p>
              <div>
                <iframe src=""></iframe>
                <div class="defenciveee-descriptions">
                  <span>
    ...
    <div class="defenciveee-vid-book-pop">
      <div>
        <div>
    ...
    <div class="defenciveee-vid-book-spinn">
      <div>
        <span></span>
      </div>
    </div>
