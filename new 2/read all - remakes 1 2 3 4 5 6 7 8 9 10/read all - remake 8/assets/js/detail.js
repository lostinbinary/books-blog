const iframeBtn = document.querySelector(
  ".stumbleee-descriptions span[data-link]",
);
const overlay = document.querySelector(".stumbleee-descriptions");
const iframe = document.querySelector(".stumbleee-iframe iframe");
...
const moreLess = document.querySelector(".stumbleee-less-more");
const textEl = document.querySelector(".stumbleee-staff-text");
