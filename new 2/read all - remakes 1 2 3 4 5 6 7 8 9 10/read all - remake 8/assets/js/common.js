window.addEventListener("load", function () {
  const boxes = document.querySelectorAll(".stumbleee-boxes-list>div");
  ...
  const viewBtn = document.querySelectorAll(".stumbleee-vdoc-view");
  const splinner = document.querySelector(".stumbleee-vdoc-book-spinn");
  const pdfPop = document.querySelector(".stumbleee-vdoc-book-pop");
  const iframePop = document.querySelector(".stumbleee-vdoc-book-pop iframe");
  const iframePopBody = document.querySelector(".stumbleee-vdoc-book-pop>div>div>div");
  boxes.forEach((item, idx) => {
    let dataLink = item.getAttribute("data-link");
