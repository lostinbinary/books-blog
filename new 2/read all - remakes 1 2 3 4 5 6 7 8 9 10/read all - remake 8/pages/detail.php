...
<html lang="en">
  ...
  <body>
    ...
    <div class="stumbleee-container centered-element">
      <div>
        <div class="stumbleee-boxes">
          <div class="stumbleee-iframe-description">
            <div class="stumbleee-iframe">
              <h1><?= $data->book->title ?> </h1>
              <p><?= $data->book->description ?> </p>
              <div>
                <iframe src=""></iframe>
                <div class="stumbleee-descriptions">
                  <span>
    ...
    <div class="stumbleee-vdoc-book-pop">
      <div>
        <div>
    ...
    <div class="stumbleee-vdoc-book-spinn">
      <div>
        <span></span>
      </div>
    </div>
