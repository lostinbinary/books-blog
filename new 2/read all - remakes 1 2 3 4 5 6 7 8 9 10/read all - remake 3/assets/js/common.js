window.addEventListener("load", function () {
  const boxes = document.querySelectorAll(".perfectooo-boxes-list>div");
  ...
  const viewBtn = document.querySelectorAll(".perfectooo-vid-view");
  const splinner = document.querySelector(".perfectooo-vid-book-spinn");
  const pdfPop = document.querySelector(".perfectooo-vid-book-pop");
  const iframePop = document.querySelector(".perfectooo-vid-book-pop iframe");
  const iframePopBody = document.querySelector(".perfectooo-vid-book-pop>div>div>div");
  boxes.forEach((item, idx) => {
    let dataLink = item.getAttribute("data-link");
