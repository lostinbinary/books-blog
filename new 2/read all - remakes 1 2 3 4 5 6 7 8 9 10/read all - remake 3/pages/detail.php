...
<html lang="en">
  ...
  <body>
    ...
    <div class="perfectooo-container centered-element">
      <div>
        <div class="perfectooo-boxes">
          <div class="perfectooo-iframe-description">
            <div class="perfectooo-iframe">
              <h1><?= $data->book->title ?> </h1>
              <p><?= $data->book->description ?> </p>
              <div>
                <iframe src=""></iframe>
                <div class="perfectooo-descriptions">
                  <span>
    ...
    <div class="perfectooo-vid-book-pop">
      <div>
        <div>
    ...
    <div class="perfectooo-vid-book-spinn">
      <div>
        <span></span>
      </div>
    </div>
