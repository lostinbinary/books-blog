...
<html lang="en">
  ...
  <body>
    ...
    <div class="bindeddd-container centered-element">
      <div>
        <div class="bindeddd-boxes">
          <div class="bindeddd-iframe-description">
            <div class="bindeddd-iframe">
              <h1><?= $data->book->title ?> </h1>
              <p><?= $data->book->description ?> </p>
              <div>
                <iframe src=""></iframe>
                <div class="bindeddd-descriptions">
                  <span>
    ...
    <div class="bindeddd-vid-book-pop">
      <div>
        <div>
    ...
    <div class="bindeddd-vid-book-spinn">
      <div>
        <span></span>
      </div>
    </div>
