window.addEventListener("load", function () {
  const boxes = document.querySelectorAll(".bindeddd-boxes-list>div");
  ...
  const viewBtn = document.querySelectorAll(".bindeddd-vid-view");
  const splinner = document.querySelector(".bindeddd-vid-book-spinn");
  const pdfPop = document.querySelector(".bindeddd-vid-book-pop");
  const iframePop = document.querySelector(".bindeddd-vid-book-pop iframe");
  const iframePopBody = document.querySelector(".bindeddd-vid-book-pop>div>div>div");
  boxes.forEach((item, idx) => {
    let dataLink = item.getAttribute("data-link");
