...
<html lang="en">
  ...
  <body>
    ...
    <div class="special-readdd-container centered-element">
      <div>
        <div class="special-readdd-boxes">
          <div class="special-readdd-iframe-description">
            <div class="special-readdd-iframe">
              <h1><?= $data->book->title ?> </h1>
              <p><?= $data->book->description ?> </p>
              <div>
                <iframe src=""></iframe>
                <div class="special-readdd-descriptions">
                  <span>
      ...
      <div class="special-readdd-boxes">
        <div class="special-readdd-boxes-list">
