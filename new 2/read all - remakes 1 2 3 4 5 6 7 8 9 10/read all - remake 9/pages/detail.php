...
<html lang="en">
  ...
  <body>
    ...
    <div class="cohersionnn-container centered-element">
      <div>
        <div class="cohersionnn-boxes">
          <div class="cohersionnn-iframe-description">
            <div class="cohersionnn-iframe">
              <h1><?= $data->book->title ?> </h1>
              <p><?= $data->book->description ?> </p>
              <div>
                <iframe src=""></iframe>
                <div class="cohersionnn-descriptions">
                  <span>
    ...
    <div class="cohersionnn-vid-book-pop">
      <div>
        <div>
    ...
    <div class="cohersionnn-vid-book-spinn">
      <div>
        <span></span>
      </div>
    </div>
