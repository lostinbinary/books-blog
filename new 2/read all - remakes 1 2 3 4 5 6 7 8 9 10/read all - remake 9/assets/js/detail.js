const iframeBtn = document.querySelector(
  ".cohersionnn-descriptions span[data-link]",
);
const overlay = document.querySelector(".cohersionnn-descriptions");
const iframe = document.querySelector(".cohersionnn-iframe iframe");
...
const moreLess = document.querySelector(".cohersionnn-less-more");
const textEl = document.querySelector(".cohersionnn-staff-text");
