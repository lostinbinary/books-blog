window.addEventListener("load", function () {
  const boxes = document.querySelectorAll(".cohersionnn-boxes-list>div");
  ...
  const viewBtn = document.querySelectorAll(".cohersionnn-vid-view");
  const splinner = document.querySelector(".cohersionnn-vid-book-spinn");
  const pdfPop = document.querySelector(".cohersionnn-vid-book-pop");
  const iframePop = document.querySelector(".cohersionnn-vid-book-pop iframe");
  const iframePopBody = document.querySelector(".cohersionnn-vid-book-pop>div>div>div");
  boxes.forEach((item, idx) => {
    let dataLink = item.getAttribute("data-link");
