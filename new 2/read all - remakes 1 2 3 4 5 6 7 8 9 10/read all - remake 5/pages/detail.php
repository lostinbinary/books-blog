...
<html lang="en">
  ...
  <body>
    ...
    <div class="educateddd-container centered-element">
      <div>
        <div class="educateddd-boxes">
          <div class="educateddd-iframe-description">
            <div class="educateddd-iframe">
              <h1><?= $data->book->title ?> </h1>
              <p><?= $data->book->description ?> </p>
              <div>
                <iframe src=""></iframe>
                <div class="educateddd-descriptions">
                  <span>
    ...
    <div class="educateddd-vid-book-pop">
      <div>
        <div>
    ...
    <div class="educateddd-vid-book-spinn">
      <div>
        <span></span>
      </div>
    </div>
