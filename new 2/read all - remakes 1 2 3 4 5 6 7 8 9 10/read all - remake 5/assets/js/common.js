window.addEventListener("load", function () {
  const boxes = document.querySelectorAll(".educateddd-boxes-list>div");
  ...
  const viewBtn = document.querySelectorAll(".educateddd-vid-view");
  const splinner = document.querySelector(".educateddd-vid-book-spinn");
  const pdfPop = document.querySelector(".educateddd-vid-book-pop");
  const iframePop = document.querySelector(".educateddd-vid-book-pop iframe");
  const iframePopBody = document.querySelector(".educateddd-vid-book-pop>div>div>div");
  boxes.forEach((item, idx) => {
    let dataLink = item.getAttribute("data-link");
