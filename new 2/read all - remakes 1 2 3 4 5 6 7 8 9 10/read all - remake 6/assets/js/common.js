window.addEventListener("load", function () {
  const boxes = document.querySelectorAll(".measuresss-boxes-list>div");
  ...
  const viewBtn = document.querySelectorAll(".measuresss-vid-view");
  const splinner = document.querySelector(".measuresss-vid-book-spinn");
  const pdfPop = document.querySelector(".measuresss-vid-book-pop");
  const iframePop = document.querySelector(".measuresss-vid-book-pop iframe");
  const iframePopBody = document.querySelector(".measuresss-vid-book-pop>div>div>div");
  boxes.forEach((item, idx) => {
    let dataLink = item.getAttribute("data-link");
