...
<html lang="en">
  ...
  <body>
    ...
    <div class="measuresss-container centered-element">
      <div>
        <div class="measuresss-boxes">
          <div class="measuresss-iframe-description">
            <div class="measuresss-iframe">
              <h1><?= $data->book->title ?> </h1>
              <p><?= $data->book->description ?> </p>
              <div>
                <iframe src=""></iframe>
                <div class="measuresss-descriptions">
                  <span>
    ...
    <div class="measuresss-vid-book-pop">
      <div>
        <div>
    ...
    <div class="measuresss-vid-book-spinn">
      <div>
        <span></span>
      </div>
    </div>
