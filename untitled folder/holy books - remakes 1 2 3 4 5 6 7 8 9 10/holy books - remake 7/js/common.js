window.addEventListener("load", function () {
  const boxes = document.querySelectorAll(".throughhh-boxes-list>div");
  const viewBtn = document.querySelectorAll(".throughhh-view-book");
  const splinner = document.querySelector(".throughhh-book-spinn");
  const pdfPop = document.querySelector(".throughhh-book-pop");
  const iframePop = document.querySelector(".throughhh-book-pop iframe");
  const iframePopBody = document.querySelector(".throughhh-book-pop>div>div>div");
