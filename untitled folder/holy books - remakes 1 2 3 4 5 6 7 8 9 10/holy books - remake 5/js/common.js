window.addEventListener("load", function () {
  const boxes = document.querySelectorAll(".gradientsss-boxes-list>div");
  const viewBtn = document.querySelectorAll(".gradientsss-view-book");
  const splinner = document.querySelector(".gradientsss-book-spinn");
  const pdfPop = document.querySelector(".gradientsss-book-pop");
  const iframePop = document.querySelector(".gradientsss-book-pop iframe");
  const iframePopBody = document.querySelector(".gradientsss-book-pop>div>div>div");
