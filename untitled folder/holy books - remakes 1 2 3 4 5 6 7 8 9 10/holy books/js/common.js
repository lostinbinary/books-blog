window.addEventListener("load", function () {
  const boxes = document.querySelectorAll(".hollyy-boxes-list>div");
  const viewBtn = document.querySelectorAll(".hollyy-view-book");
  const splinner = document.querySelector(".hollyy-book-spinn");
  const pdfPop = document.querySelector(".hollyy-book-pop");
  const iframePop = document.querySelector(".hollyy-book-pop iframe");
  const iframePopBody = document.querySelector(".hollyy-book-pop>div>div>div");
