window.addEventListener("load", function () {
  const boxes = document.querySelectorAll(".sickeddd-boxes-list>div");
  const viewBtn = document.querySelectorAll(".sickeddd-view-book");
  const splinner = document.querySelector(".sickeddd-book-spinn");
  const pdfPop = document.querySelector(".sickeddd-book-pop");
  const iframePop = document.querySelector(".sickeddd-book-pop iframe");
  const iframePopBody = document.querySelector(".sickeddd-book-pop>div>div>div");
